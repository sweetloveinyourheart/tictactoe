    ...
    return (
        <section className="guide-component">
            <div className="container">
                ...
                <div className="guide-area">
                    <h1 className="guide-title">Types Of Play To Avoid</h1>
                    <div className="row">
                        <div className="col-xl-6">
                            <div className="guide-image">
                ...
                <div className="guide-area">
                    <h1 className="guide-title">Tic Tac Toe Strategy</h1>
                    <div className="row">
                        <div className="col-xl-7">
                            <div className="guide">
                                <h2 className="guide-title">Strategy #1: Go First If Possible</h2>
                                <br />
                        ...
                        <div className="col-xl-5">
                            <div className="guide">
                                <h2 className="guide-title">Strategy #2: For When You Get Stuck Going Second</h2>
                                <br />
                                <p>
